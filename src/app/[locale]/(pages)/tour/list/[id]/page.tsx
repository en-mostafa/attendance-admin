import EditForm from "../../../../../../components/tour/edit/EditForm";
...
export default async function EditTour({ params }: { params: Promise<{ id: string }> }) {
    ...
    const data = await getData(`/tour/${id}`);
                ...
                <div id="kt_app_toolbar_container" className="app-container container-xxl d-flex flex-stack flex-wrap">
                    <div className="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                        <div className="page-title d-flex flex-column justify-content-center gap-1 me-3">
                            <h1 className="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-3 m-0">{t('edit_tour')}</h1>
                        </div>
