import { ButtonSubmit } from "@/components/hotel/book/Button";
import { Form } from "@/components/hotel/book/Form";
import { BookStatus } from "@/components/hotel/book/Status";
...
export default async function Page({ 
    ...
    const data = await getData(`/payment/product/room/${id}`);
                                        ...
                                        <table className="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                            <tbody className="fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    <td className="text-muted">
                                                        <div className="d-flex align-items-center">
                                                        <i className="ki-outline ki-wallet fs-2 me-2"></i>{t("method_pay")}</div>
                                                    </td>
                                                    <td className="fw-bold text-end">{data?.paiedType === 'ATM' ? t('card') : t("currency")}</td>
                                                </tr>
                                                {data?.paiedType === 'ATM' ? (
                                                    <tr>
                                                        <td className="text-muted">
                                        ...
                                        <table className="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                            <tbody className="fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="fw-bold text-end">
                                                        <span className="text-gray-600 text-hover-primary">{data?.user.email}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td className="text-muted">
                                                        <div className="d-flex align-items-center">
                                                        <i className="ki-outline ki-phone fs-2 me-2"></i>{t("phone")}</div>
                                                    </td>
                                        ...
                                        <table className="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                            <tbody className="fw-semibold text-gray-600">
                                                <tr>
                                                    <td className="text-muted">
                                                        <div className="d-flex align-items-center">
                                                            <i className="ki-outline ki-shop fs-2 me-2"></i>
                                                            {t("hotel_name")} 
                                                        </div>
                                                    </td>
                                                    <td className="fw-bold text-end">
                                                        <Link href={`/hotel/list/${data?.items.hotel.id}`} className="text-gray-600 text-hover-primary">{data?.items.hotel.name}</Link>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td className="text-muted">
                                                        <div className="d-flex align-items-center">
                                                            <i className="ki-outline ki-star fs-2 me-2"></i>
                                                            {t("star_title")}
                                                        </div>
                                                    </td>
                                                    <td className="fw-bold text-end">
                                                        <span className="fw-bold text-end">{data?.items.hotel.stars}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td className="text-muted">
                                                        <div className="d-flex align-items-center">
                                                            <i className="ki-outline ki-map fs-2 me-2"></i>
                                                            {t("address")} 
                                                        </div>
                                                    </td>
                                                    <td className="fw-bold text-end">
                                                        <span className="fw-bold text-end text-truncate w-150px d-block ms-auto">{data?.items.hotel.address}</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                                        ...
                                                        <table className="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                                            <tbody className="fw-semibold text-gray-600">
                                                                <tr>
                                                                    <td className="text-muted">
                                                                        <div className="d-flex align-items-center">
                                                                        <i className="ki-outline ki-shop me-2 fs-2"></i>{t("title")}
                                                                        </div>
                                                                    </td>
                                                                    <td className="fw-bold text-end">
                                                                        <div className="d-flex align-items-center justify-content-end">
                                                                            <Link href={`/hotel/list/rooms/edit/${data?.items.translattedRoom.id}`} className="text-gray-600 text-hover-primary">{data?.items.translattedRoom.type}</Link>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td className="text-muted">
                                                                        <div className="d-flex align-items-center">
                                                                        <i className="ki-outline ki-profile-circle fs-2 me-2"></i>{t("capacity")}</div>
                                                                    </td>
                                                                    <td className="fw-bold text-end">
                                                                        <span className="text-gray-600 text-hover-primary">{data?.items.translattedRoom.numberOfGuests} {t("person")}</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td className="text-muted">
                                                                        <div className="d-flex align-items-center">
                                                                        <i className="ki-outline ki-calendar fs-2 me-2"></i>{t("date_checkin_checkout")}</div>
                                                                    </td>
                                                                    <td className="fw-bold text-end" dir="ltr">{useJalaliFormat(data?.checkIn, locale) + " ~ " + useJalaliFormat(data?.checkOut, locale)}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                            ...
                                            <div className="card card-flush py-4 flex-row-fluid position-relative">
                                                ...
                                                <div className="card-body pt-0">
                                                    <input 
                                                        ...
                                                        placeholder={`${t("hour_checkin")} (${t("example")}: 12:40)`}
                                                    />
                                                </div>
                                                <div className="card-header">
                                                    <div className="card-title">
                                                        <h2>{t("hour_checkout_room")}</h2>
                                                    </div>
                                                </div>
                                                <div className="card-body pt-0">
                                                    <input 
                                                        ...
                                                        className="form-control" 
                                                        placeholder={`${t("hour_checkout")} (${t("example")}: 12:40)`}
                                                    />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="card card-flush py-4 flex-row-fluid position-relative w-100">
                                                ...
                                                <div className="card-body pt-0">
                                                    <input 
                                                        ...
                                                        className="form-control" 
                                                        placeholder={t("description_enter")}
                                                    />
                                                </div>
                                            </div>
                                            <div className="card card-flush py-4 flex-row-fluid position-relative w-100">
                                                    ...
                                                    <table className="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                                        <thead>
                                                            <tr className="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                                                ...
                                                                <th className="min-w-70px text-end">{t("phone_number")}</th>
                                                                <th className="min-w-100px text-end">{t("passport_number")}</th>
                                                        ...
                                                        <tbody className="fw-semibold text-gray-600">
                                                            ...
                                                            <tr>
                                                                <td className="text-start fw-bold fs-3 text-black">{t("detail_pay")}</td>
                                                            </tr>
                                                            <tr>
                                                                <td colSpan={4} className="text-end">{t("total_amount")}</td>
                                                                <td className="text-end">{pipeNumber(data?.price)}</td>
                                                            </tr>
                                                            <tr>
                                                                <td colSpan={4} className="text-end">{t("total_discount")} ({data?.discount}%)</td>
                                                                <td className="text-end">{pipeNumber(data?.discountPrice)}</td>
                                                            </tr>
                                                            <tr>
                                                                <td colSpan={4} className="text-end">{t("total_tax")} ({data?.tax}%)</td>
                                                                <td className="text-end">{pipeNumber(data?.taxPrice)}</td>
                                                            </tr>
                                                            <tr>
                                                                <td colSpan={4} className="text-end">{t("stay_time")}</td>
                                                                <td className="text-end">{data?.stayDays} {t("day")}</td>
                                                            </tr>
                                                            <tr>
                                                                <td colSpan={4} className="fs-3 text-gray-900 text-end">{t("total_payment")}</td>
