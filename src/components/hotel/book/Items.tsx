...
export default function Items({ item } : { item:any }) {
    ...
    return (
            <tr>
                ...
                <td>
                    <span className="text-gray-900 fw-bold text-hover-primary d-block mb-1 fs-6">{item?.items.hotel.name}</span>
                </td>
                <td>
                    <span className="text-gray-900 fw-bold text-hover-primary d-block mb-1 fs-6">#{item?.items.hotel.id}</span>
                </td>
                <td>
                    <span className="text-gray-900 fw-bold text-hover-primary d-block mb-1 fs-6">{item?.paiedType === 'ATM' ? t('card') : t('currency')}</span>
                </td>
                <td>
                ...
                <td className="text-end">
                    <Link href={`/hotel/book/${item?.id}`} className="btn btn-icon btn-bg-light btn-active-color-primary btn-sm ms-1">
