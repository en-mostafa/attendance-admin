import { adminStatus } from "@/services/adminServices";
import { useTranslations } from "next-intl";
import { startTransition, useActionState, useEffect, useState } from "react"

export default function AdminStatus({ data }: { data:any }) {
    const t = useTranslations('Public');
    const[checked, setChecked] = useState(data?.deletedAt === null ? true : false);
    const [state, action] = useActionState(adminStatus, null);
