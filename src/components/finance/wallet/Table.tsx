        ...
        <table className="table align-middle table-row-dashed gs-0 gy-4">
            <thead>
                <tr className="fw-bold text-muted bg-light border-0">
                    ...
                    <th className="ps-4 min-w-150px rounded-start">{t("date_register")}</th>
                    <th className="ps-4 min-w-150px rounded-start">{t("amount")}</th>
                    <th className="ps-4 min-w-150px rounded-start">{t("operation")}</th>
                    <th className="min-w-50px text-end rounded-end px-4">{t("describe")}</th>
                </tr>
            </thead>
            <tbody>
                <>
